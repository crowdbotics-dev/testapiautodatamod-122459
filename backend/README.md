...
## Project Structure
    ...
    ├── testapiautodatamod_122459  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_122459`
...
2. Clone this repo and `cd testapiautodatamod_122459`
